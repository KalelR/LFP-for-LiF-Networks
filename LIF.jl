...
plotSpikeRate(m_tS_ext, 1, 0, t_exec, "results/spikeTimes/spikeRateNoise_LIF_v" * code_version * "_Ni_" * string(Ni) * "_Ne_" * string(Ne) * "_seed_" * string(seed) * "_conductances_1_rate_" * string(ν0) * ".png")
# plotSpikeRate(tt, 1, 0, t_exec) #media da rede
plotSpikeRate_IE(tt, 1, 10, t_exec, v_inh, "results/spikeTimes/spikeRateNetwork_LIF_v" * code_version * "_Ni_" * string(Ni) * "_Ne_" * string(Ne) * "_seed_" * string(seed) * "_conductances_1_rate_" * string(ν0) * ".png")
...
plotRaster(tt, v_inh, "results/RP/RP_LIF_v" * code_version * "_Ni_" * string(Ni) * "_Ne_" * string(Ne) * "_seed_" * string(seed) * "_conductances_1_rate_" * string(ν0) * ".png")
